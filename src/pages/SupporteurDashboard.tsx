...
export function SupporteurDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-8">
        <h1 className="text-3xl font-serif font-bold text-gold mb-2">Tableau de bord Supporteur</h1>
        <p className="text-gray-400">Bienvenue, {userProfile?.displayName || 'Supporteur'}. Gérez les demandes d'assistance.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div 
          onClick={() => navigate('/supporteur/messages')}
        ...
        >
          ...
          <h3 className="text-xl font-bold text-gray-100 mb-2">Messagerie Support</h3>
          <p className="text-gray-400 text-sm">Répondez aux questions et assistez les utilisateurs.</p>
        </div>
